    ...
    <>
      ...
      <div className="fixed inset-0 -z-10 bg-navy-950">
        <motion.img
          ...
          className="absolute inset-0 h-full w-full object-cover object-[90%_50%] saturate-[1.5] contrast-[1.1] brightness-[1.22] sm:object-[72%_50%]"
        />
        <motion.div
      ...
      <section id="top" className="relative flex min-h-[100dvh] items-center pt-18">
        <div className="relative z-10 mx-auto w-full max-w-[1400px] px-6 lg:px-10 xl:px-16">
          <div className="max-w-2xl lg:max-w-3xl">
            <h1 className="break-words text-4xl font-bold leading-[1.1] text-white sm:text-5xl md:text-6xl lg:text-7xl [@media(max-height:600px)]:lg:text-5xl [@media(max-height:600px)]:xl:text-6xl">
              {headline.map((line, i) => (
                <motion.span
                  key={line}
            ...
            <motion.p
              {...fadeUp(0.72)}
              className="mt-6 max-w-[54ch] text-base leading-relaxed text-white/85 md:text-lg [@media(max-height:600px)]:mt-4"
            >
      ...
      <div className="relative z-20 bg-white">
        <div className="mx-auto w-full max-w-[1400px] px-6 py-10 md:py-14 lg:px-10 xl:px-16">
          <motion.div
            ...
            <div className="grid grid-cols-1 gap-10 lg:grid-cols-3 lg:divide-x lg:divide-navy-800">
              {stats.map((stat, i) => (
                ...
                >
                  ...
                  <p className="whitespace-nowrap font-mono text-4xl font-bold tabular-nums text-white xl:text-5xl">
