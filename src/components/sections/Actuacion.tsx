...
export function Actuacion() {
  ...
  return (
    <section id="actuacion" className="bg-navy-950">
      <div className="grid lg:grid-cols-2">
        <motion.div
          ...
          className="relative isolate min-h-[320px] overflow-hidden lg:min-h-0"
        >
          <img
            src={MAP_PLACEHOLDER}
            alt=""
            ...
            loading="lazy"
            decoding="async"
            className="absolute inset-0 h-full w-full object-cover object-[70%_50%] saturate-[1.02] contrast-[1.02] brightness-[0.75]"
          />
          <div className="absolute inset-0 bg-gradient-to-br from-navy-950/35 via-navy-950/25 to-navy-950/85" />
        ...
        <motion.div
          ...
          className="relative isolate overflow-hidden px-6 py-20 sm:px-10 sm:py-24 lg:px-16 lg:py-24 2xl:px-24 2xl:py-32"
        >
          <div
            aria-hidden="true"
          ...
          <div className="relative">
            ...
            <div className="mt-10 flex flex-col divide-y divide-white/15 2xl:mt-12">
